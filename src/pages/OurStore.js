...
const OurStore = () => {
  const [grid, setGrid] = useState(4); //this chnages the grid config to change how you view the products
            ...
            <div className="row">
                <div className="col-3">
                    ...
                    Filter By</h3>
                        <div>
                            ...
                            <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="" id="color-1" value="checkedValue"  />
                                    S (2)
                                  </label>
                                </div>
                                <div class="form-check">
                    ...
                    <div>
                      <div className="random-products mb-3 d-flex">
                        ...
                        <div className="w-50">
                          <h5>
                            Kids headphones 10pack with 5 different colours
                          </h5>
                          <ReactStars
                 count={5}
                 size={24}
                ...
                <div className="d-flex  align-items-center gap-10 grid">
                    ...
                    id="" >
                      ...
                      <option value="title-ascending">Latest to Oldest</option>
                      <option value="title-ascending">Oldest to Latest</option>
                    </select>
                  </div>
                  <div className="d-flex  align-items-center gap-10">
